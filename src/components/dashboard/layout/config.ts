...
export const navItems = [
  ...
  { key: '课题三', title: '图计算编程环境', href: paths.dashboard.integrations, icon: 'plugs-connected',
    subItems: [
      {key: '内容一', title: '内容一', href: paths.dashboard.part3_sub1},
      {key: '内容二', title: '内容二', href: paths.dashboard.part3_sub2}
    ]
  },
  { key: '课题四', title: '分布式图计算框架', href: paths.dashboard.settings, icon: 'gear-six',
    subItems: [
      {key: '内容一', title: '内容一', href: paths.dashboard.part4_sub1},
      {key: '内容二', title: '内容二', href: paths.dashboard.part4_sub2}
    ]
  },
  { key: '课题五', title: '泛图计算典型应用', href: paths.dashboard.account, icon: 'user',
    subItems: [
